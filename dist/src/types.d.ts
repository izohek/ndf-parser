 ...
 * objectname ( <content> )
 */
export declare class ParserObject implements ParserNdfType {
    name: string;
    type: string;
 ...
 */
export declare type ParserChildValue = ParserArray | ParserGuid | ParserStringLiteral | ParserTildeLiteral | ParserObject | ParserMap | ParserRgbaValue | ParserTuple;
/**
 * NDF GUID Value
 *
 * Example:
 ...
 * `
 */
export declare class ParserArray implements ParserNdfType {
